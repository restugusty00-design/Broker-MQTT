...
export default function App() {
  ...
  const handleVoiceCommand = (cmd: string, rawText: string) => {
    ...
    switch(cmd) {
      ...
      case 'QUERY_TEMP': speak(`Suhu saat ini ${temperature.toFixed(1)} derajat celcius`); break;
      case 'QUERY_HUM': speak(`Kelembapan saat ini ${humidity.toFixed(1)} persen`); break;
      case 'QUERY_ALL': speak(`Suhu ${temperature.toFixed(1)} derajat, kelembapan ${humidity.toFixed(1)} persen`); break;
      case 'CLEAR_LOG': 
        setLogs([]);
